...
/**
 * A ProgressivoAdozione.
 */
@Entity
@Table(name = "PROGRESSIVOADOZIONE",uniqueConstraints={@UniqueConstraint(columnNames={ "anno","aoo_id","tipoprogressivo_id"} )}/*TODO,
indexes={
...
public class ProgressivoAdozione implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        ProgressivoAdozione progressivoAdozione = (ProgressivoAdozione) o;

        if ( ! Objects.equals(id, progressivoAdozione.id)) return false;
