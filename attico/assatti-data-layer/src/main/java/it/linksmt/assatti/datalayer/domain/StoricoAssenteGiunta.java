 ...
 */
@Entity
@Table(name = "STORICO_ASSENTE_GIUNTA" )
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class StoricoAssenteGiunta implements Serializable {
	...
	public StoricoAssenteGiunta(final Long id) {
		this.id = id;
	}

	public StoricoAssenteGiunta() {
	}
	
	@Id
	@Column(name = "idassente_giunta")
	private Long id;
    ...
    public boolean equals(Object o) {
        ...
        StoricoAssenteGiunta sag = (StoricoAssenteGiunta) o;
