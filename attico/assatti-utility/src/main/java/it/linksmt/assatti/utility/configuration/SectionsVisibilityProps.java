...
public final class SectionsVisibilityProps extends AbstractConfigProperties {
	private SectionsVisibilityProps() { }

	private static PropertiesConfiguration _props = null;

    static {
    	_props = loadProperties(ConfigPropNames.SECTIONS_VISIBILITY_CONFIG_FILENAME);       
    }
