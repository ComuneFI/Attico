 ...
 *
 */
public class DbLoaderTemplateResolver
        extends TemplateResolver {

    
    
    
    public DbLoaderTemplateResolver(ModelloHtmlRepository modelloHtmlRepository ) {
        super();
        super.setResourceResolver(new DbLoaderResourceResolver(  modelloHtmlRepository ));
    }
