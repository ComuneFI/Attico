...
import it.linksmt.assatti.bpm.util.CleanBpmThreadLocalListener;
import it.linksmt.assatti.datalayer.config.hazelcast.CacheConfiguration;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        // IMPORTANTE: rimuove le variabili THREAD-LOCAL
        servletContext.addListener(new CleanBpmThreadLocalListener());
        
        
        EnumSet<DispatcherType> disps = EnumSet.of(DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.ASYNC);
       // initClusteredHttpSessionFilter(servletContext, disps);CDM
...
//        }
    ...
    private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        parameters.put("instance-name", "cifra2gestatti");
...
//				new ServletContainer(), "/bpm/*");
//		registration.addInitParameter(
//				ServletProperties.JAXRS_APPLICATION_CLASS,
//				JerseyBpmConfig.class.getName());
//
//		return registration;
//	}
