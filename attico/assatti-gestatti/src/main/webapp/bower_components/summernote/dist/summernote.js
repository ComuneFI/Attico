...
(function (factory) {
  ...
  var defaults = {
    ...
    options: {
      ...
      fontNames: [
        ...
        'Tahoma', 'Times New Roman', 'Titillium Web', 'Verdana'
      ],
  ...
  var Table = function () {
    ...
    this.createTable = function (colCount, rowCount) {
      ...
      for (var idxCol = 0; idxCol < colCount; idxCol++) {
        tds.push('<td style="border: 1px solid #000000; padding-top: 0.05cm; padding-bottom: 0.05cm; padding-left: 0.05cm; padding-right: 0.6cm; ">' + dom.blank + '</td>');
      }
      tdHTML = tds.join('');
      ...
      trHTML = trs.join('');
      return $('<table class="table table-bordered" width="570">' + trHTML + '</table>')[0];
    };
  };
  ...
  var Renderer = function () {
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      if(options.readOnly){
    	  $editable = $('<div class="note-editable panel-body" contentEditable="' + !options.readOnly + '"></div>').prependTo($editingArea);
      }else{
    	  $editable = $('<div class="note-editable panel-body" contentEditable="' + isContentEditable + '"></div>').prependTo($editingArea);
      }
