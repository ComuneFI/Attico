(function (root, factory) {
    ...
    return {
      ...
      link: function (scope, element, attrs, ctrls) {
        ...
        ckeditor.ready().then(function initialize() {
          ...
          ckeditor.instance.setReadOnly(!!(attrs.contenteditable && attrs.contenteditable == 'false'));
		  scope.$watch(function() {
			    return element.attr('contenteditable'); 
		  }, function(contenteditable){
			    ckeditor.instance.setReadOnly(!!(contenteditable && contenteditable == 'false'));
		  });
          /*
		  attrs.$observe('contenteditable', function (contenteditable) {
            ckeditor.instance.setReadOnly(!!(contenteditable && contenteditable == 'false'));
          });
		  */
  ...
  function ckeditorController($scope, $element, $attrs, $parse, $q) {
    ...
    var instance = this.instance = CKEDITOR.replace(editorElement, config);
